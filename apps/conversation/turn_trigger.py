...
#   - apps.conversation.request_facade.build_agent_subject_activity_intent_payload
#   - apps.conversation.request_facade.build_agent_manifest_item_lookup_intent_payload
#

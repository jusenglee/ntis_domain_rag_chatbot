...
def _resolve_question_analysis_count(question_analysis: Any, *, question: str, request_id: Optional[str], conversation_id: str) -> None:
...
async def build_intent_payload(
    *,
    ...
    visible_answer_manifest = getattr(active_view_state, "visible_answer_manifest", None)
    subject_index = getattr(active_view_state, "subject_index", {}) or {}
    scope_focus_entity = get_active_focus_entity(active_view_state)
    active_anchor_entity = get_active_child_anchor(active_view_state)

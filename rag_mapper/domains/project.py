...
def get_project_schema() -> TagSchema:
    ...
    return TagSchema(
        ...
        label_map={
            ...
            # --- meta_detail (상세 정보) ---
            "rnd_phase_nm": "연구개발단계코드",
            "rsch_exec_suj_nm": "연구수행주체코드",
            "snt_std_cls_nm": "과학기술표준분류코드",
            "rsch_area_cls1_nm": "과학기술표준분류코드(신)1",
            "rsch_area_cls2_nm": "과학기술표준분류코드(신)2",
            "rsch_area_cls3_nm": "과학기술표준분류코드(신)3",
            "mstr_lcls_nm": "부처자제분류 대분류명",
            "mstr_mcls_nm": "부처자제분류 중분류명",
            "mstr_scls_nm": "부처자제분류 소분류명",
            "rnd_clas_nm": "연구개발성격구분",
            "prctuse_yn": "실용화대상여부구분",
            "t6tech_nm": "6T관련기술코드",
            "nat_strt_tech_nm": "국가중점과학기술코드",
            "tech_lifecyc_nm": "기술수명주기코드",
            "dtl_pjt_clas_nm": "세부과제성격코드",
            "pjt_prgs_stat_slct_nm": "과제진행상태구분",
            "gt_cls_nm": "녹색기술분야 분류코드",

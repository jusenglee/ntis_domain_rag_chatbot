...
from apps.conversation.anchor_constraint_compiler import merge_seed_into_ids_map
from apps.conversation.request_facade import _apply_anchor_lock, _apply_followup_context_lock
...
def test_merge_seed_prefers_pjt_id_over_pjt_no():
    ...
    merged = merge_seed_into_ids_map(ids_map, seed_map)

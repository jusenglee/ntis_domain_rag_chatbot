...
import apps.planner.planner_runtime as planner_runtime_module
import apps.retrieval.rag_retriever as rag_retriever_module
from apps.retrieval.rag_retriever import detect_retrieval_query_drift, repair_query_for_resolved_anchor, resolve_rag_queries
from apps.conversation.followup_anchor import anchor_to_seed_map
from apps.evidence.detail_contract import compute_detail_coverage
from apps.conversation.view_state import ActiveScope, ConversationViewState, DisplayItem, DisplaySnapshot, FocusEntity
from apps.planner.planner_service import apply_planner_strategy, apply_question_analysis_v3, collect_researcher_name_terms, merge_planner_hints, normalize_hint_terms
from apps.planner.planner_runtime import _apply_deterministic_stage2_repair, _normalize_stage2_slots_payload, _planner_prev_context_text, _sanitize_stage2_structured_filters
from apps.conversation.request_facade import build_intent_payload
from apps.conversation.view_state import build_display_snapshot, render_display_snapshot_text
...
from apps.retrieval.retrieval_workflow import (
...
from apps.conversation.followup_resolution import build_followup_clarification_message, build_followup_clarification_payload, resolve_reference_context_followup
from apps.platform.pipeline_steps import NormalizedIntent, normalize_intent
from apps.planner.planner_contract import validate_planner_contract
from apps.planner.planner_staged import compose_locked_strategy, regate_locked_strategy
from apps.planner.query_intent import QueryIntent, classify_query
from apps.retrieval.rag_pipeline import _validate_intent_payload_version
    ...
    payload, _ = asyncio.run(
        build_intent_payload(
            ...
            view_state=ConversationViewState(
                visible_answer_manifest=DisplaySnapshot(
                    view_id='view-1',
                    conversation_id='cid',
                    turn_id='turn-1',
                    context_kind='project',

...
from apps.chat.answer_generation import build_answer_context, generate_answer
from apps.retrieval.rag_retriever import CustomRAGRetriever
from apps.platform import triton_client
from apps.platform.openai_compat_llm import OpenAICompatChatModel
from apps.retrieval.rag_pipeline import run_rag_ab_compare
from apps.platform.settings import TRITON_TIMEOUTS
...
def test_custom_rag_retriever_forwards_request_overrides(monkeypatch):
    ...
    monkeypatch.setattr("apps.retrieval.rag_retriever.run_rag_ab_compare", fake_run_rag_ab_compare)
...
def test_custom_rag_retriever_fails_fast_for_stale_run_rag_ab_compare(monkeypatch):
    ...
    monkeypatch.setattr("apps.retrieval.rag_retriever.run_rag_ab_compare", legacy_run_rag_ab_compare)
